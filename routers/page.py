...
def _with_admin_link(html: str) -> str:
    ...
    return html.replace("{{ADMIN_CONSOLE_LINK}}", '<a href="/static/admin_console.html" target="_blank" rel="noopener noreferrer" class="admin-console-link">🛠</a>' if show_link else "")
