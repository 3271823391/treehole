...
def build_plan_block(plan: ReplyPlan) -> str:
    return (
        "[REPLY_CONTROL]\n"
...
def build_messages(system_prompt: str, plan: ReplyPlan, history_text: str, current_input: str) -> list[dict]:
    return [
        {"role": "system", "content": system_prompt},
        {"role": "system", "content": build_plan_block(plan)},
        {
            "role": "user",
            "content": f"对话历史:\n{history_text}\n\n用户本轮输入:\n{current_input}",
        },
